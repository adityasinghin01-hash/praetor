...
566 tests hold those claims. Approving as an agent raises PermissionError, in the tests
...
and no billing: `make install && make demo` gives 566 passing tests, the rules baseline,
...
566 passing tests, the rules baseline at precision 0.800 / recall 0.963 / F1 0.874, and
